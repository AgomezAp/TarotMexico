  ...
  try {
    const order = {
      ...
      application_context: {
        ...
        failure_url: `https://cartastarotmexico.com/welcome`,
        cancel_url: `https://cartastarotmexico.com/welcome`,
      },
    };
...
export const captureOrder = async (req, res) => {
  ...
  try {
    ...
    if (response.data.status === "COMPLETED") {
      ...
      return res.redirect(
        `https://cartastarotmexico.com/descripcion-cartas?status=NOT_COMPLETED&token=${rejectToken}`
      );
    }
  } catch (error) {
    if (error.response) {
